...
Design a voltage amplifier with a gain $G = 3$.
Since we are using an ideal op-amp we assume that $A$ is infinite hence the gain will be:
...
It is now asked to designa a non-inverting amplifier with a gain $G = 10000$.\\
...
And that $A$ (open-loop gain) is:

\begin{equation}
	aa
\end{equation}

Then $A\beta$ (loop gain) is:
