...
We will now say that this text, differently from what you must be seen in other courses, is not a book that can be followed in theoretical manner but need to be seen more as a guide specific to this course and as launchpad for the introduction to embedded systems. 
...
\begin{enumerate}
	...
	\item[\textbf{-}] Actuators and control – 1 CFU
\end{enumerate}
