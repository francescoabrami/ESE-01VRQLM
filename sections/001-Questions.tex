...
\vspace*{1.5cm}
\subsection{Firmware design - Questions}
\subsection{Firmware design - Answers}

\vspace*{1.5cm}
\subsection{Firmware benchmarking LAB04B - Questions}
\subsection{Firmware benchmarking LAB04B - Answers}

\vspace*{1.5cm}
\subsection{Advanced firmware and sensors - Questions}
\subsection{Advanced firmware and sensors - Answers}

\vspace*{1.5cm}
\subsection{NTC Sensor LAB05 - Questions}
\subsection{NTC Sensor LAB05 - Answers}

\vspace*{1.5cm}
\subsection{Actuators and firmware control - Questions}
\subsection{Actuators and firmware control - Answers}

\vspace*{1.5cm}
\subsection{Actuator LAB06 - Questions}
\subsection{Actuator LAB06 - Answers}

\vspace*{1.5cm}
\subsection{I$^2$C Memories Final project - Questions}
\subsection{I$^2$C Memories Final project - Answers}
